module.exports = {
  ...
  Token: process.env.Token || "OTUyMDg4ODUyNzA3ODM1OTc0.Yiw71w.DV_V2Iuk1y78iu8QhQVZCtKAQjY", //Discord Bot Token
  ClientID: process.env.Discord_ClientID || "952088852707835974", //Discord Client ID
  ClientSecret: process.env.Discord_ClientSecret || "XrWXpWU2NvejYhRWDaJZRGDbQ9XnMb7N", //Discord Client Secret
  ...
  Spotify: {
    ClientID: process.env.Spotify_ClientID || "8a9f0b48befe484e8b168c583dc3ad1d", //Spotify Client ID
    ClientSecret: process.env.Spotify_ClientSecret || "9d48fbcf9ce941f09fab6f4cb9a1738b", //Spotify Client Secret
  },
};
